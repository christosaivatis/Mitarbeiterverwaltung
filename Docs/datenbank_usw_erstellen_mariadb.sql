...
CREATE TABLE Bsv 
(
	Bsv_ID INT NOT NULL AUTO_INCREMENT,
	Bsv_Bezeichnung VARCHAR(50),
...
(
	...
	Wohnort_Ort_ID VARCHAR(50),
	Abteilung_Abt_ID INT,
	Bsv_Bsv_ID INT,
